...
public class SpiralArray {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.deepToString(genSpiral(3)));
        System.out.println(Arrays.deepToString(genSpiral(4)));
        System.out.println(Arrays.deepToString(genSpiral(8)));
    }
}
