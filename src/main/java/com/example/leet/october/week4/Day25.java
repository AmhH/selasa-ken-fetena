 ...
 * If Alice starts removing 1 stone, Bob will remove 4 stones then Alice only can remove 1 stone and finally Bob
 * removes the last one (7 -> 6 -> 2 -> 1 -> 0).
 * Example 5:
 *
 * Input: n = 17
 * Output: false
 ...
 * 1 <= n <= 10^5
 *    Hide Hint #1
 * Use dynamic programming to keep track of winning and losing states. Given some number of stones, Alice can win if
 * she can force Bob onto a losing state.
 */
public class Day25 {
